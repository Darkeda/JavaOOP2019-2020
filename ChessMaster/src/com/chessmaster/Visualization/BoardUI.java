...
//                        board[selecedPiece.getCoordinateX()][selecedPiece.getCoordinateY()].move(getX()/50,getY()/50);
//                        updateUI();
//                    } else {
//                        setBackground(Color.BLUE);
//                        if( board[getX()/50][getY()/50] !=null)
//                        {
//                            selecedPiece.setCoordinateX(getX()/50);
//                            selecedPiece.setCoordinateY(getY()/50);
//                        }
//
//                    }
//                }
